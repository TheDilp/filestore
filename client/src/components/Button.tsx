...
const classes = tv({
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      isOutline: true,
      hasNoBorder: false,
      class: "text-info hover:text-white active:text-white",
    },
    {
      variant: "success",
      isOutline: true,
      hasNoBorder: false,
      class: "text-success hover:text-white active:text-white",
    },
    {
      variant: "warning",
      isOutline: true,
      hasNoBorder: false,
      class: "text-warning hover:text-white active:text-white",
    },
    {
      variant: "error",
      isOutline: true,
      hasNoBorder: false,
      class: "text-error hover:text-white active:text-white",
    },
    {
      variant: "primary",
      isOutline: true,
